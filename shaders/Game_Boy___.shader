...
uniform float4 color_1 = {0.102, 0.059, 0.024, 1.0};
uniform float4 color_2 = {0.400, 0.122, 0.039, 1.0};
uniform float4 color_3 = {0.749, 0.325, 0.051, 1.0};
uniform float4 color_4 = {0.949, 0.773, 0.035, 1.0};
