...
uniform float4 non_edge_color = {1.0,1.0,1.0,1.0};
uniform bool non_edge_multiply = true;
uniform bool alpha_channel = false;
...
float4 mainImage(VertData v_in) : TARGET
{
	...
	float4 edgy_color = float4(sin(elapsed_time*1.001),sin(elapsed_time*1.002+1.0),sin(elapsed_time+2.0), 0.5);
